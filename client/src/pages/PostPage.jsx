 ...
 fetchRecentPost();
  ...
  <h1 className="text-3xl mt-10 p-3 text-center font-serif max-w-2xl mx-auto lg:text-4xl"> {post && post.title}</h1>
   ...
   <img src={post&&post.image} className="mt-10 p-3 max-h-[600px] w-full object-cover"/>
    ...
    <div dangerouslySetInnerHTML={{__html:post&&post.content}} className="p-3 max-w-2xl mx-auto w-full poat-content first-line:">
    </div>
    ...
    <div className="flex flex-col justify-center items-center mb-5">
       <h1 className="text-xl mt-6">Recent Articles</h1>
