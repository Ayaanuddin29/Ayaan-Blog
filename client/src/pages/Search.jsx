...
const handleShowMore=async()=>{
  ...
  return (
    <div className="flex flex-col md:flex-row">
        ...
        <h1 className="text-3xl font-semibold mt-3 sm:border-b border-gray-500 p-3">Post Results</h1>
        <div className="p-7 flex flex-wrap gap-4">
                ...
                {
                    showMore && <button onClick={handleShowMore} className="text-teal-500 text-lg w-full hover:underline">Show More</button>
                }
            </div>
            </div>
