...
function CallToAction() {
  return (
    <div className="flex flex-col sm:flex-row border border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl mx-auto text-center">
        ...
        <Button className="rounded-tl-xl w-full rounded-bl-none" gradientDuoTone='purpleToPink'><a href='https://www.100jsprojects.com' rel='noopener noreferrer' target="_blank">100 JavaScript Projects</a>  </Button>
        </div>
