...
function DashboardComp() {
  ...
  try{
    ...
    if(res.ok){
        ...
        setLastMothUsers(data.lastMonthUsers);
    }
}
    catch(err){
        console.log(err)
 ...
 <div className="flex flex-wrap gap-4 py-3">
   <div className="flex flex-col w-full shadow-md md:w-auto p-2 rounded-md dark:bg-gray-800">
        ...
        {users && users.map(user=>(
           <Table.Body key={user._id} className="divide-y">
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              <Table.Cell><img src={user.profilePicture} className="w-10 h-10 rounded-full bg-gray-500"/></Table.Cell>
    ...
    <Table hoverable>
        ...
        {posts && posts.map(post=>(
           <Table.Body key={post._id} className="divide-y">
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              <Table.Cell><img src={post.image} className="w-10 h-10 "/></Table.Cell>
